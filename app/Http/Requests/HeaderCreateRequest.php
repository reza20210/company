...
class HeaderCreateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'siteLogoId' => 'required',
            'siteVideoId' => 'required',
            'siteVideoPosterId' => 'required',
            'workTime' => 'required',
            'telegram' => 'required',
            'instagram' => 'required',
            'youtube' => 'required',
    ...
    public function messages()
    {
        return [
            ...
            'title.required' => 'لطفا عنوان سایت را وارد کنید',
            'title.address' => 'لطفا آدرس شرکت را وارد کنید',
            'description.required' => 'لطفا توضیحات بخش فوتر سایت را وارد کنید',
            'siteLogoId.required' => 'لطفا لوگوی سایت را وارد کنید',
            'siteVideoId.required' => 'لطفا ویدئو سایت را وارد کنید',
            'siteVideoPosterId.required' => 'لطفا پوستر ویدئو سایت را وارد کنید',
